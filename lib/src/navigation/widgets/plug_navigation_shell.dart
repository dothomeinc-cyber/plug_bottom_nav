...
import '../providers/plug_selected_index_provider.dart';
...
///  * keeps [plugSelectedIndexProvider] in sync automatically, so any page
///    in the app can read the active tab with
...
class _PlugNavigationShellState extends ConsumerState<PlugNavigationShell> {
  ...
  void _syncIndex() {
    // Defer to after build to avoid mutating provider state during widget
    // build.
